    ...
    return (
        <>
            <div className='relative w-full flex gap-3 justify-center '>
                <div className="logo bg-white flex item-center justify-center p-5">
                    <img src="/static/logo.svg" alt="Image 404" className='h-[124px]'/>
                </div>
                ...
                <div className='end p-5'>
                    <img src="/static/90yrs.svg" alt="Image 404" className='h-[124px]' />
                </div>
            </div>
        </>
    )
